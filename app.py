...
if not ss.started:
    ...
    with st.expander("Participant Information Sheet (please read in full)", expanded=True):
        st.markdown(
            ...
            "people with different levels of programming experience. An LLM Model 1 generates a piece of "
            "code in response to a prompt, and a second Model 2 provides explanation of the generated code "
            "in response to a prompt adapted to your experience level. We want to find out whether "
            "explanations that are matched to your level of experience are more helpful and satisfying than "
            "a single general explanation.\n\n"
